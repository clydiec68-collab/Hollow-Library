...
const SPELLS = [
  {
    ...
    icon: "🕯️",
    tier: "Candle & Ritual",
    desc: "A complete candle magic guide for the solitary witch. Protection wards, intention-setting rituals, and a full colour correspondence chart. Includes printable grimoire pages for recording your workings.",
    payhipId: "XXXXX",
    pages: "21 pages",
  },
  {
    ...
    icon: "🌙",
    tier: "Moon & Seasonal",
    desc: "Work with the rhythm of the moon and the turning wheel of the year. Rituals for each lunar phase, an overview of the eight sabbats, and a printable lunar tracker for your grimoire.",
    payhipId: "XXXXX",
    pages: "16 pages",
  },
  {
    ...
    icon: "🌿",
    tier: "Herbal",
    desc: "A grounded guide to herbal correspondences for the practicing witch. Recipes for ritual oils, protective sachets, and intention teas. Includes a printable herb log to build your personal materia magica.",
    payhipId: "XXXXX",
    pages: "17 pages",
  },
  {
    ...
    icon: "📖",
    tier: "Collection",
    desc: "All three guides in one — The Solitary Flame, Phases & Passages, and Root & Remedy — plus a bonus set of grimoire journal templates: daily practice log, spell record sheet, and dream journal page.",
    payhipId: "XXXXX",
